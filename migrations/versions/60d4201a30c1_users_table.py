...
Revision ID: 60d4201a30c1
Revises: 
Create Date: 2018-02-28 00:45:57.799405
...
def upgrade():
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('emails', sa.String(length=140), nullable=True),
    sa.Column('phone', sa.String(length=140), nullable=True),
    sa.Column('technician', sa.String(length=140), nullable=True),
    sa.Column('user_id', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['user_id'], ['user.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
